    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (user != null)
            {
                ...
                {
                    ViewBag.errorMessage = "Potwierdź e-mail, aby się zalogować.";
                    return View("Error");
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Potwierdź konto", "Cześć " + user.Name + "\n\nPotwierdź konto, klikając " +
                        "poniższy link:\n\n" + callbackUrl);

                    ViewBag.Message = "Zanim będziesz mógł się zalogować, sprawdź swój e-mail w celu potwierdzenia konta.";
