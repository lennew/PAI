...
namespace Tournaments.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<Battle> userBattles = new List<Battle>();
            List<Tournament> userTournaments = new List<Tournament>();
            foreach (Enrollment e in model.Enrollments)
            {
                userTournaments.Add(e.Tournament);
                userBattles.AddRange(e.Tournament.Battles.Where(b => b.Player1.Id == userId || b.Player2.Id == userId));
            }
            ViewBag.Battles = userBattles;
            ViewBag.Tournaments = userTournaments.ToPagedList(1, 100);
            return View(model);
        }
